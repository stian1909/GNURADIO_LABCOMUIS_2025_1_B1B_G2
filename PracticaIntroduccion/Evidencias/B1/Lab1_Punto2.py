...
# Author: Nicolas_Martinez_Jairo_Moreno_E1B_G6
...
class Lab1_Punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "frequencia de muestreo", "counter_slider", float, QtCore.Qt.Horizontal)
